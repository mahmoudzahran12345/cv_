                                ...
                                FadeInDown(
                                    ...
                                    child: Column(
                                      children: [
                                        Text(
                                             "New Password"),
                                        TextField(controller: ChangePasswordCubit.get(context).newPassword,)
                                      ],
                                    )),
                                FadeInDown(
                                    delay: const Duration(milliseconds: 600),
                                    ...
                                    child: Column(
                                      children: [
                                        Text(
                                             "Confirm Password"),
                                        TextField(controller: ChangePasswordCubit.get(context).confirmPassword,)
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: MaterialButton(
                                      ...
                                      height: 60,
                                      onPressed: () {
                                        ChangePasswordCubit.get(context).newPassWord();
