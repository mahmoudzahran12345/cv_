import 'package:create_cv/Screens/CompanyDirection/PlanPage/payment_methods_bottom_sheet.dart';
              ...
              Row(
                children: [
                  ...
                  const Column(
                    ...
                    children: [
                      Text(
                        " Enhanced CV organization tools",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 12,
                            fontFamily: 'Arimo'),
              ...
              Row(
                children: [
                  ...
                  const Column(
                    ...
                    children: [
                      Text(
                        " Basic analytics (number of views,",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 12,
                            fontFamily: 'Arimo'),
